...
# The intended outcome of this program was to ask if the user would like to do a dry run. However, due to the task of asking for an input from the user
# to be impossible, this program won't work and instead will always do a dry run unless manually changed in the code.

# If the input did work, this would ask for the prompt. as it asks for a input of Y or N and then sets dryRun to either true or false.
# userInput = ""
#dryRun is true in case somehow the user doesn't select one and it goes through.
# dryRun = True
# while (userInput != "Y" and userInput != "N"):
#         userInput = input("Would you like to run this program in a dry run? (Y/N): ")
# if userInput == "Y":
#         dryRun = True
# elif userInput == "N":
#         dryRun = False
...
def main():
	...
	# These lines that are commented out would've used dryRun to either determine if it is a dry run or not and then react accordingly
        # if dryRun == True:
        print(cmd)
        # elif dryRun == False:
        # os.system(cmd)
        # else:
                # print("Error: dryRun is not True or False")
